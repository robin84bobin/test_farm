...
public class UIAtlas : MonoBehaviour
{
	...
	// Replacement atlas can be used to completely bypass this atlas, pulling the _messageViewData from another one instead.
	...
	/// <summary>
	/// Performs an upgrade from the legacy way of specifying _messageViewData to the new one.
	/// </summary>
