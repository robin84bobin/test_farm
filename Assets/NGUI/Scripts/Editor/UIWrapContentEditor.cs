...
public class UIWrapContentEditor : Editor
{
	public override void OnInspectorGUI ()
	{
		...
		string fieldName = "DataItem Size";
		string error = null;
		...
		if (!serializedObject.isEditingMultipleObjects)
		{
			...
			else if (sv.movement == UIScrollView.Movement.Horizontal) fieldName = "DataItem Width";
			else if (sv.movement == UIScrollView.Movement.Vertical) fieldName = "DataItem Height";
			else
			{
