...
public class UIGeometry
{
	...
	/// <summary>
	/// Whether the geometry has usable transformed vertex _messageViewData.
	/// </summary>

	public bool hasTransformed { get { return (mRtpVerts != null) && (mRtpVerts.size > 0) && (mRtpVerts.size == verts.size); } }

	/// <summary>
	/// _stepData 1: Prepare to fill the buffers -- make them clean and valid.
	/// </summary>
	...
	/// <summary>
	/// _stepData 2: Transform the vertices by the provided matrix.
	/// </summary>
	...
	/// <summary>
	/// _stepData 3: Fill the specified buffer using the transformed values.
	/// </summary>
