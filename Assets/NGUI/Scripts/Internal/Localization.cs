...
public static class Localization
{
	...
	/// <summary>
	/// Notification triggered when the localization _messageViewData gets changed, such as when changing the language.
	/// If you want to make modifications to the localization _messageViewData after it was loaded, this is the place.
	/// </summary>
	...
	/// <summary>
	/// Set the localization _messageViewData directly.
	/// </summary>
	...
	static public string Get (string key)
	{
		...
		if (mLanguages == null)
		{
			Debug.LogError("No localization _messageViewData present");
			return null;
		}
